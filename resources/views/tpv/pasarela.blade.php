    ...
    <div class="payment-container">
        <div class="payment-box">
            ...
            <div class="payment-details">
                <h2>Importe:</h2>
                <div class="amount">{{ $viewData['tpv']->amount }} &euro;</div>
            ...
            <div class="payment-form">
                ...
                <form action="{{ route('tpv.pagar', ['key' => $viewData['tpv']->key]) }}" method="POST">
                    @csrf
                    <input type="hidden" id="key" value="{{ $viewData['tpv']->key }}">
                    ...
                    <div class="form-group">
                        <label for="cvv">C&oacute;d. Seguridad CVV</label>
