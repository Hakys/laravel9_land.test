...
@section('content')
    <div class="container">
        ...
        <ul>
            ...
            <li><a href="{{ route('xml.importfile') }}">Import Archivo</a></li>
            <li><a href="{{ route('xml.loadfile', 300) }}">Cargar Archivo (300 productos)</a></li>
    ...
    <div class="container">
        ...
        <div class="row row-cols-auto justify-content-between g-2">
            @foreach ($productos as $p)
                <div class="col"><a href="{{ route('xml.show', $p->referencia) }}">{{$p->referencia}}</a></div>
            @endforeach
        </div>
    </div>
@endsection