...
Route::middleware('admin')->group(function () {
    ...
    Route::get('/reunion/{id}', 'App\Http\Controllers\ReunionController@show')->name("reunion.show");
    ...
    Route::delete('/reunion/{id}/delete', 'App\Http\Controllers\ReunionController@delete')->name("reunion.delete");

    /* IMPORT */

    Route::get('/import/contacto', 'App\Http\Controllers\ImportController@importContacto')->name("import.contacto");
