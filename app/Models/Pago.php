...
class Pago extends Model
{
    ...
    public function conceptos(){ return ['entrada','venta','reserva']; }
    ...
    public function setConcepto($value){
        if(in_array($value,$this->conceptos())) $this->attributes['concepto'] = $value; }
    public function getImporte(){ return $this->attributes['importe']; }
    public function getImporteEuro(){ return $this->formatmoneda($this->attributes['importe']); }
    ...
    public function setMetodo($value){
        if(in_array($value,$this->getMetodos())) $this->attributes['metodo'] = $value; }
    ...
    public function formatmoneda($amount) {
        // Formatear el número con dos decimales y usar coma como separador de decimales
